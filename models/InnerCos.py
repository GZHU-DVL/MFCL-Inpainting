...
class InnerCos(nn.Module):
    ...
    def set_target(self, targetde, targetst):
        self.targetst = F.interpolate(targetst, size=(32, 32), mode='bilinear', align_corners=True)
        self.targetde = F.interpolate(targetde, size=(32, 32), mode='bilinear', align_corners=True)

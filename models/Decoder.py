...
class Decoder(nn.Module):
    ...
    def forward(self, input_1, input_2, input_3, input_4, input_5, input_6):
        y_1 = self.Decoder_1(input_6)  # 512 => 512
        y_2 = self.Decoder_2(torch.cat([y_1, input_5], 1))  # 512+512 => 512
        y_3 = self.Decoder_3(torch.cat([y_2, input_4], 1))  # 512+512 => 256
        y_4 = self.Decoder_4(torch.cat([y_3, input_3], 1))  # 256+256 => 128
        y_5 = self.Decoder_5(torch.cat([y_4, input_2], 1))  # 128+128 => 64
        y_6 = self.Decoder_6(torch.cat([y_5, input_1], 1))  # 64 + 64 => 3
        out = y_6

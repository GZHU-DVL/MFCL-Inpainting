...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--st_root', type=str,
                            default=r'',
                            help='path to structure images')
        parser.add_argument('--de_root', type=str,
                            default=r'',
        ...
        parser.add_argument('--name', type=str, default='Encoder-Decoder',
